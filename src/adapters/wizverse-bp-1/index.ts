...
class Wizverse extends BasicProvider {
    ...
    // Optional: known module addresses that might receive fees
    private readonly moduleAddresses: string[];
    ...
    constructor(options: IBasicProviderOptions) {
        ...
        // Known module addresses provided by user (lowercased)
        this.moduleAddresses = [
            "0xb97c1e5255fa6fa898263688cff9e19796674d96",
            "0x37be9ab432197ad3cd4e2b3208fd1fd6a5d59764",
            "0x56237acbe3763c4d5db585837a1c22ffbe53c55c",
        ];
    }
    ...
    process = async (event: EventData): Promise<ISaleEntity | undefined> => {
        const from = (event.returnValues["from"] as string).toLowerCase();
        const to = (event.returnValues["to"] as string).toLowerCase();
