...
class KalaoSale {
    ...
    getSeller = (event) => {
        if (event.event === "SaleStarted") {
            return event.returnValues.sellerAddress;
        }
        return null;
    };
    ...
    process = async (event) => {
        ...
        const nftContract = event.returnValues.tokenAddres.toLowerCase();
        const entity = {
